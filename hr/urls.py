...
urlpatterns = [
    ...
    path('left-employees/export/csv/', views.export_clearance_csv, name='hr_export_clearance_csv'),
    path('left-employees/export/excel/', views.export_clearance_excel, name='hr_export_clearance_excel'),
    path('left-employees/import/excel/', views.import_clearance_excel, name='hr_import_clearance_excel'),
]
